...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugElementary Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugElementary Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugElementary Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugElementary installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugElementary Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugElementary installer\n"
